...
class UserINPUT(BaseModel):
    ...
    weight: Annotated[float, Field(..., gt=2, lt=400, description='Weight of the user in kgs')]
    height: Annotated[float, Field(..., gt=0.54, lt=2.72, description='Height of the user in meters')]
